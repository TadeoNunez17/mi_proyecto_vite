...
function ResponsiveAppBar() {
  ...
  useEffect(() => {
    switch (myPages) {
      case "":           navigate("/");           break;
      case "PRODUCTOS":  navigate("/products");   break;
      case "PRECIOS":    navigate("/prices");     break;
      case "ORDENES":    navigate("/orders");     break;
      case "PAGOS":      navigate("/payments");   break;
      case "ENVIOS":     navigate("/shippings");  break;
    }
  }, [myPages]);
